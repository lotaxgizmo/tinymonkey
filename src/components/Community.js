    ...
    return (
        <div id='community' className='flex flex-col items-center justify-center relative p-4'>
            ...
            <div className='bg-[#FFD401] flex flex-col justify-center items-start rounded-xl lg:rounded-2xl my-10  lg:w-11/12 lg:p-4d  overflow-clip.  border-black border-2 p-4 lg:p-24 relative'>
                ...
                <div className="btn flex flex-colf  lg:w-auto w-full lg:flex-row justify-center items-center">
                    ...
                    <a href="https://t.me/tinymonkeycommunity" target="_blank" rel="noopener noreferrer"><img src={telegram} alt="" className='lg:m-4 m-1 w-12' /></a>
                    <a href="https://x.com/tinythemonkey" target="_blank" rel="noopener noreferrer"><img src={twitter} alt="" className='lg:m-4 m-1 w-12' /></a>
                    <a href="https://dexscreener.com/solana/65litgsmzjjlqu53etji8bgb5tjpltsxwnbxphftsnrt" target="_blank" rel="noopener noreferrer"><img src={dexscreenerbtn} alt="" className='lg:m-4 m-1 w-12' /></a>
